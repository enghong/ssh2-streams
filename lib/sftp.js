...
function SFTPStream(cfg, remoteIdentRaw) {
  ...
  this.encoding = (typeof cfg.encoding === 'string' ? cfg.encoding : 'utf8');
            ...
            if (pktType === REQUEST.OPEN) {
              ...
              */
              ...
              /*
                string     path
              */
              path = readString(buffer, 4, this.encoding, this, callback);
              if (path === false)
                return;
              ...
              */
              var str1;
              var str2;
              str1 = readString(buffer, 4, this.encoding, this, callback);
              if (str1 === false)
                return;
              str2 = readString(buffer, buffer._pos, this.encoding, this, callback);
              if (str2 === false)
                return;
...
SFTPStream.prototype.open = function(path, flags_, attrs, cb) {
  ...
  /*
    ...
    ATTRS         attrs
  */
  var pathlen = Buffer.byteLength(path, this.encoding);
  var p = 9;
  ...
  buf.write(path, p += 4, pathlen, this.encoding);
...
SFTPStream.prototype.unlink = function(filename, cb) {
  ...
  /*
    ...
    string     filename
  */
  var fnamelen = Buffer.byteLength(filename, this.encoding);
  var p = 9;
  ...
  buf.write(filename, p += 4, fnamelen, this.encoding);
...
SFTPStream.prototype.rename = function(oldPath, newPath, cb) {
  ...
  /*
    ...
    string     newpath
  */
  var oldlen = Buffer.byteLength(oldPath, this.encoding);
  var newlen = Buffer.byteLength(newPath, this.encoding);
  var p = 9;
  ...
  buf.write(oldPath, p += 4, oldlen, this.encoding);
  writeUInt32BE(buf, newlen, p += oldlen);
  buf.write(newPath, p += 4, newlen, this.encoding);
...
SFTPStream.prototype.symlink = function(targetPath, linkPath, cb) {
  ...
  /*
    ...
    string     targetpath
  */
  var linklen = Buffer.byteLength(linkPath, this.encoding);
  var targetlen = Buffer.byteLength(targetPath, this.encoding);
  var p = 9;
  ...
  if (this._isOpenSSH) {
    ...
    buf.write(targetPath, p += 4, targetlen, this.encoding);
    writeUInt32BE(buf, linklen, p += targetlen);
    buf.write(linkPath, p += 4, linklen, this.encoding);
  } else {
...
SFTPStream.prototype.ext_openssh_fstatvfs = function(handle, cb) {
  ...
  */
  ...
  buf.write(handle, p += 4, handlelen, this.encoding);
